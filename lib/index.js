...
var aTable = function (_aTemplate) {
  ...
  function aTable(ele, option) {
    ...
    data.row = _this.parse(selector.innerHTML);
  ...
  _createClass(aTable, [{
    ...
    value: function getCellInfoByIndex(x, y) {
      ...
      var headers = this._getElementByQuery('.js-table-header th');
      var sides = this._getElementByQuery('.js-table-side');
