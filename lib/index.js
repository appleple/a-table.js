...
var aTable = function (_aTemplate) {
  (0, _inherits3.default)(aTable, _aTemplate);

  function aTable(ele, option) {
    (0, _classCallCheck3.default)(this, aTable);

    var _this2 = (0, _possibleConstructorReturn3.default)(this, (aTable.__proto__ || (0, _getPrototypeOf2.default)(aTable)).call(this));

    _this2.id = idGen.next().value;
    _this2.menu_id = idGen.next().value;
    _this2.addTemplate(_this2.id, template);
    _this2.addTemplate(_this2.menu_id, menu);
    _this2.data = _zeptoBrowserify.$.extend(true, {}, defs, option);
    var data = _this2.data;
    data.point = { x: -1, y: -1 };
    data.selectedRowNo = -1;
    data.selectedColNo = -1;
    data.showBtnList = true;
    data.row = _this2.parse((0, _zeptoBrowserify.$)(ele).html());
    data.tableClass = _this2.getTableClass(data.tableResult);
    data.highestRow = _this2.highestRow;
    data.history = [];
    data.inputMode = 'table';
    data.cellClass = '';
    data.history.push((0, _clone2.default)(data.row));
    _this2.convert = {};
    _this2.convert.getStyleByAlign = _this2.getStyleByAlign;
    _this2.convert.setClass = _this2.setClass;
    var html = '\n    <div class=\'a-table-container\'>\n        <div data-id=\'' + _this2.menu_id + '\'></div>\n        <div class=\'a-table-outer\'>\n          <div class=\'a-table-inner\'>\n            <div data-id=\'' + _this2.id + '\'></div>\n          </div>\n        </div>\n    </div>';
  ...
  (0, _createClass3.default)(aTable, [{
    key: 'highestRow',
    ...
    value: function undo() {
      ...
      while ((0, _stringify2.default)(row) === (0, _stringify2.default)(data.row)) {
        row = hist.pop();
      }
